...
run :-
    ...
    print_menu(["Please, give us information about AUTO.",
               ...
               [get_expert_preference(AutoChoosenVariant),
                get_expert_preference(RoadChoosenVariant),
                get_expert_preference(DriverChoosenVariant)]),
    
    auto_eval_from_variant(AutoChoosenVariant, AutoEval),
    road_eval_from_variant(RoadChoosenVariant, RoadEval),
    driver_eval_from_variant(DriverChoosenVariant, DriverEval),
